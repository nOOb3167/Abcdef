...
FUNCTION(GOB2IZE GOBFILE)
 ...
 ##CMAKE_CURRENT_SOURCE_DIR ...src/mgob
 ##GOB2IZE(nx-base.gob)
 ##ADD_EXECUTABLE(BLAH, ${CMAKE_CURRENT_BINARY_DIR}/nx-base.c)
 GET_FILENAME_COMPONENT(GOBABS "${GOBFILE}" ABSOLUTE)
 GET_FILENAME_COMPONENT(GOBPATH "${GOBFILE}" PATH)
 FILE(RELATIVE_PATH TEMP_PRE_GOBPATH "${CMAKE_SOURCE_DIR}" "${GOBABS}")
 GET_FILENAME_COMPONENT(GOBPATH "${TEMP_PRE_GOBPATH}" PATH)
 GET_FILENAME_COMPONENT(GOBNAME "${GOBFILE}" NAME_WE)
 IF(NOT IS_DIRECTORY "${CMAKE_BINARY_DIR}/${GOBPATH}")
  MESSAGE(FATAL_ERROR "GOB2IZE: BINARY_DIR/GOBPATH not a directory.\
 ...
 ADD_CUSTOM_COMMAND(OUTPUT "${CMAKE_BINARY_DIR}/${GOBPATH}/${GOBNAME}.c"
  ...
  IMPLICIT_DEPENDS
  DEPENDS "${GOBFILE}"
  WORKING_DIRECTORY "${CMAKE_BINARY_DIR}/${GOBPATH}"
